...
CONFIG_ARGS = --host=aarch64-kos --target=aarch64-kos --build=x86_64-linux-gnu --disable-shared --enable-static --with-libpcap=internal --with-libpcre=internal --with-nbase=internal --with-nsock=internal --without-liblua --without-libssh2 --without-libz --without-openssl --without-ndiff --without-zenmap --without-nmap-update
